  ...
  return (
    <div>
      ...
      <div className="wall-bg">
          ...
          <p className="homepage-desc-intro">Hello my name is Fatahillah, I am 17 years old, I come from Indonesia and live in Tangerang. This is my personal website created with the aim of introducing myself, On this website I share some information about me.</p>
          <br></br>
